...
sensord0_c = tk.Label(root, text = 'Sensor d0', font = ('calibre', 10), fg = '#4876FF')
sensord0_c.place(x = 20, y = 600)
sensord1_c = tk.Label(root, text = 'Sensor d1', font = ('calibre', 10), fg = '#EE0000')
sensord1_c.place(x = 100, y = 600)
sensord2_c = tk.Label(root, text = 'Sensor d2', font = ('calibre', 10), fg = 'orange')
sensord2_c.place(x = 180, y = 600)
sensord3_c = tk.Label(root, text = 'Sensor d3', font = ('calibre', 10), fg = '#008B45')
sensord3_c.place(x = 260, y = 600)
sensord4_c = tk.Label(root, text = 'Sensor d4', font = ('calibre', 10), fg = '#708090')
sensord4_c.place(x = 340, y = 600)
root.mainloop()
