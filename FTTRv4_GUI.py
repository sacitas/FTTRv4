...
kp_label.place(x = 780, y = SP_label.winfo_y()+SP_label.winfo_reqwidth() + 30)
...
ti_label.place(x = 780, y = kp_label.winfo_y()+kp_label.winfo_reqwidth() + 30)
...
td_label.place(x = 780, y = ti_label.winfo_y()+ti_label.winfo_reqwidth() + 30)
