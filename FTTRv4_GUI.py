...
def animate(i):
    ...
    plt.plot(x, dtemp2, linewidth = 1.5, label='Sensor d2', color = 'yellow')
...
sensord1_c.place(x = 40, y = 600)
sensord2_c = tk.Label(root, text = 'Sensor d2', font = ('calibre', 10), fg = 'yellow')
sensord2_c.place(x = 60, y = 600)
sensord3_c = tk.Label(root, text = 'Sensor d3', font = ('calibre', 10), fg = 'green')
sensord3_c.place(x = 80, y = 600)
sensord4_c = tk.Label(root, text = 'Sensor d4', font = ('calibre', 10), fg = 'grey')
sensord4_c.place(x = 100, y = 600)
root.mainloop()
