...
SP_label.place(x = 770, y = 100)
SP_ent = tk.Entry(root, width=7)
SP_ent.insert(0, SP)
SP_ent.place(x = 850, y = 100)

root.update()
kp_label = tk.Label(root, text = 'Gain:', font = ('calibre', 10))
kp_label.place(x = 770, y = SP_label.winfo_y()+SP_label.winfo_reqwidth() + 10)
kp_ent = tk.Entry(root, width=7)
kp_ent.insert(0, KP)
kp_ent.place(x = 850, y = SP_label.winfo_y()+SP_label.winfo_reqwidth() + 10)

root.update()
ti_label = tk.Label(root, text = 'Integral\ntime:', font = ('calibre', 10))
ti_label.place(x = 770, y = kp_label.winfo_y()+kp_label.winfo_reqwidth() + 10)
ti_ent = tk.Entry(root, width=7)
ti_ent.insert(0, TI)
ti_ent.place(x = 850, y = kp_label.winfo_y()+kp_label.winfo_reqwidth() + 10)

root.update()
td_label = tk.Label(root, text = 'Derivative\ntime:', font = ('calibre', 10))
td_label.place(x = 770, y = ti_label.winfo_y()+ti_label.winfo_reqwidth() + 10)
td_ent = tk.Entry(root, width=7)
td_ent.insert(0, TD)
td_ent.place(x = 850, y = ti_label.winfo_y()+ti_label.winfo_reqwidth() + 10)

root.update()
man_label = tk.Label(root, text = 'Manual\nvalue:', font = ('calibre', 10))
man_label.place(x = 765, y = td_label.winfo_y()+td_label.winfo_reqwidth() + 10)
man_ent = tk.Entry(root, width=7)
man_ent.insert(0, "0")
man_ent.place(x = 850, y = td_label.winfo_y()+td_label.winfo_reqwidth() + 10)

#-------Creates button-------
root.update()
SV = tk.Button(root, text = "APPLY", font = ('calibri', 12), command = lambda: SetRegVals())
SV.place(x = 850, y = 450, width=80, height=40)
